/* Constantes globales utilizadas por varios módulos.
   Centralizarlas aquí evita duplicación y facilita el mantenimiento. */

/* Palabras reservadas de MySQL que no deben usarse como nombres
   de tablas o columnas. Si un nombre sanitizado coincide, se
   le antepone un prefijo (t_ / c_) para evitar conflictos. */
...
'TRIGGER','TRUE','TRUNCATE','UNBOUNDED','UNDO','UNION','UNIQUE','UNLOCK',
'UNSIGNED','UPDATE','USAGE','USE','USING','UTC_DATE','UTC_TIME',
'UTC_TIMESTAMP','VALUES','VARBINARY','VARCHAR','VARCHARACTER','VARYING',
'VIRTUAL','WHEN','WHERE','WHILE','WINDOW','WITH','WITHIN','WRITE','XOR',
'YEAR_MONTH','ZEROFILL',
];

/* Cantidad máxima de filas por sentencia INSERT.
   Agrupar múltiples registros en una sola sentencia reduce
   el tamaño del script SQL y mejora la velocidad de importación. */
